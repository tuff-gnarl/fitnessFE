...
(function () {
    'use strict';
    angular
        .module('root.AdministrationViewCtrl', ['ui.router', 'camera'])
        .controller('AdministrationViewCtrl', AdministrationViewCtrl)
    AdministrationViewCtrl.$inject = ['storage', 'sensorInfo', 'WSBridge', 'WSApp'];
    function AdministrationViewCtrl(storage, sensorInfo, WSBridge, WSApp) {
        var vm = this;
        vm.storage = storage;
